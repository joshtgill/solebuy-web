"""
Django settings for solebuy project.
...
SECRET_KEY = 'je&p2=$exx(z90(6+!upl^_rg)9(_m23j=uwyqb1b++$%z$sgo'
...
WSGI_APPLICATION = 'solebuy.wsgi.application'
...
if os.getenv('GAE_APPLICATION', None):
    ...
    DATABASES = {
        'default': {
            ...
            'USER': 'joshtgill',
            'PASSWORD': 'Ars@n#l16',
            'HOST': '/cloudsql/solebuy-294315:us-central1:buyer-instance',
        }
    }
else:
